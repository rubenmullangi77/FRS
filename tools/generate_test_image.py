...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "--create-partition-cpp":
        content = """#include "core/partition_table.hpp"
#include <cstring>
#include <sstream>
#include <iomanip>
#include <algorithm>
...
"""
        with open("src/core/partition_table.cpp", "w", encoding="utf-8") as f:
            f.write(content)
        print("Generated src/core/partition_table.cpp successfully")
        sys.exit(0)
